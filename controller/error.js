...
const simulateError422 = (req, res) => {
    const data = req.body;
    console.error("Simulated 422 Error: Unprocessable Entity", { receivedData: data });
    res.status(422).json({
        status: "error",
        statusCode: 422,
...
const simulateError429 = (req, res) => {
    const data = req.body;
    console.error("Simulated 429 Error: Too Many Requests", { receivedData: data });
    res.status(429).json({
        status: "error",
        statusCode: 429,
...
const simulateError503 = (req, res) => {
    const data = req.body;
    console.error("Simulated 503 Error: Service Unavailable", { receivedData: data });
    res.status(503).json({
        status: "error",
        statusCode: 503,
